function [arc, arcOrig, pc, errs, pval, coefs1] = ParTI_with_suggestion(DataPoints,algNum,dim,DiscFeatName,EnMatDis,cols,ContFeatName,EnMatCont,GOcat2Genes,binSize,OutputFileName,arcOrig)
%% Inputs
...
if size(arcOrig,1) == 0
    [pc, arc, arcOrig, errs, pval, coefs1] = findArchetypes_with_suggestion(DataPoints,algNum,dim,OutputFileName,numIter,maxRuns);
else

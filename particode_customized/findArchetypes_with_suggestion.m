function [DataPCA,meanClstErrs,realArchs,ArchsErrors,PvalueRatio,coefs1]=findArchetypes_with_suggestion(DataPoints,algNum,dim,OutputFileName,numIter,maxRuns)
%Inputs
...
if exist('ForceNArchetypes','var') && ~isempty(ForceNArchetypes)
    ...
    if dim > 2
        ...
        T=table(NArchetypes);
        writetable(T,strcat(OutputFileName,"N"));
        %% modification: always used suggested archetypes

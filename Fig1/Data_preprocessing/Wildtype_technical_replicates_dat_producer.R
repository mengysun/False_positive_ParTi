...
#transform the data from log space to linear space (for wildtype technical replicates(referenced)) using M values and A values
dat_raw_3<-2*dat_raw_1-dat_raw_2
...
write.table(gene_id_write,"gene_id_sdNorm_for_wildtype",col.names = FALSE,row.names=FALSE,quote=FALSE)
...
write.table(dat_sd_normalized,file="dat_for_wildtype",sep=",",row.names=FALSE,col.names=FALSE)

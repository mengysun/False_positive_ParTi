...
def simulator(k):
    ...
    for r in rv:
        start = time.time()
        tree_sequence = msprime.simulate(length=1e8,recombination_rate=r,mutation_rate=1e-8, random_seed=k,model="dtwf",
        ...
        output_file="SingleChr_"+str("recombination_")+str("normal")+str("migration_")+str("normal")+str(k)
